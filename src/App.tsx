...
const STYLES = `
  ...
  *, *::before, *::after { box-sizing:border-box; margin:0; padding:0; }
  ...
  .shell { position:relative; z-index:1; max-width:680px; margin:0 auto; padding:0 16px 100px; min-height:100vh; }
  .top-bar { display:flex; align-items:center; justify-content:space-between; padding:20px 0 24px; }
  .brand { display:flex; align-items:center; gap:11px; }
  .brand-icon { width:36px; height:36px; border-radius:10px; background:linear-gradient(135deg,var(--indigo),var(--indigo-d)); display:flex; align-items:center; justify-content:center; font-size:17px; box-shadow:var(--shadow-primary); transition:transform 0.2s var(--ease),box-shadow 0.2s; }
  .brand-icon:hover { transform:scale(1.05) rotate(-3deg); }
  .brand-name { font-size:17px; font-weight:800; color:var(--text); letter-spacing:-0.5px; }
  .brand-name span { color:var(--indigo-l); }
  .hero { padding:4px 0 28px; }
  .hero h1 { font-size:clamp(26px,6.5vw,38px); font-weight:800; line-height:1.12; letter-spacing:-1px; background:linear-gradient(135deg,#ffffff 0%,rgba(241,245,249,0.9) 40%,rgba(129,140,248,0.85) 100%); -webkit-background-clip:text; -webkit-text-fill-color:transparent; background-clip:text; margin-bottom:10px; }
  .hero p { font-size:14px; color:var(--text2); line-height:1.7; max-width:380px; }
  ...
  .card-title { font-size:16px; font-weight:700; color:var(--text); margin-bottom:5px; letter-spacing:-0.3px; display:flex; align-items:center; gap:9px; }
  ...
  .card-sub { font-size:13px; color:var(--text2); line-height:1.65; margin-bottom:16px; }
  ...
  .btn { display:inline-flex; align-items:center; gap:7px; border:none; border-radius:var(--r-sm); font-family:'Plus Jakarta Sans',sans-serif; font-weight:700; font-size:13.5px; cursor:pointer; transition:all 0.18s var(--ease); white-space:nowrap; padding:11px 20px; position:relative; overflow:hidden; }
  ...
  /* Hamburger lines */
  .burger-line { display:block; width:22px; height:2px; background:var(--text2); border-radius:1px; transition:transform 0.22s ease-in-out, opacity 0.22s ease-in-out, width 0.22s ease-in-out, background 0.2s; }
  .burger-btn { display:flex; flex-direction:column; justify-content:center; gap:5px; padding:8px; background:none; border:none; cursor:pointer; border-radius:var(--r-sm); min-width:44px; min-height:44px; align-items:center; transition:background 0.15s; flex-shrink:0; }
  ...
  .section-label { font-size:11px; font-weight:700; letter-spacing:1.2px; text-transform:uppercase; color:var(--text3); margin-bottom:8px; }
  ...
  .el-name { font-size:14px; font-weight:700; color:var(--text); margin-bottom:2px; }
  .el-def { font-size:12px; color:var(--text3); }
  ...
  .session-stat-val { font-size:22px; font-weight:800; color:var(--text); line-height:1; letter-spacing:-0.5px; }
  ...
  .bottom-nav { position:fixed; bottom:0; left:0; right:0; z-index:100; background:rgba(7,9,15,0.92); backdrop-filter:blur(24px); -webkit-backdrop-filter:blur(24px); border-top:1px solid var(--border); display:flex; padding:10px 8px 14px; gap:4px; }
  .nav-item { flex:1; display:flex; flex-direction:column; align-items:center; gap:4px; padding:6px 4px; border-radius:var(--r-sm); border:none; background:transparent; cursor:pointer; transition:all 0.2s var(--ease); color:var(--text3); font-family:'Plus Jakarta Sans',sans-serif; position:relative; }
  ...
  .nav-icon-wrap { width:44px; height:28px; border-radius:999px; border:1px solid transparent; display:flex; align-items:center; justify-content:center; font-size:16px; transition:all 0.2s var(--ease); }
  .nav-label { font-size:10px; font-weight:600; transition:all 0.2s; }
  ...
  .lesson-header { display:flex; align-items:center; justify-content:space-between; padding:17px 18px; gap:12px; }
  .lesson-icon { width:38px; height:38px; border-radius:11px; display:flex; align-items:center; justify-content:center; font-size:19px; flex-shrink:0; }
  ...
  .lib-prompt-title { font-size:13.5px; font-weight:700; color:var(--text); margin-bottom:5px; letter-spacing:-0.2px; }
  .lib-prompt-preview { font-size:12px; color:var(--text3); line-height:1.55; margin-bottom:12px; display:-webkit-box; -webkit-line-clamp:2; -webkit-box-orient:vertical; overflow:hidden; }
...
const ELEMENTS = [
  {
    ...
    strong:
      'You are a marketing expert who helps B2B SaaS companies grow through LinkedIn content. Advise me on a Q4 lead generation campaign.',
  ...
  },
  {
    ...
    name: 'Objective',
    def: 'State clearly what you want done',
    ...
    strong:
      'Write 5 LinkedIn posts announcing our new product feature launch. Each under 150 words with a clear call-to-action.',
    check:
      'Is my goal specific enough that a stranger could complete it without asking me anything?',
  },
  {
    emoji: '📋',
    color: 'rgba(245,158,11,0.12)',
    name: 'Context / Background',
    def: 'Give AI the details it cannot guess',
    ...
    strong:
      'I work in B2B SaaS sales. My prospects are HR managers at companies with 200-500 employees. Q4 budget decisions are finalised in the next 3 weeks.',
    check:
      'Have I shared who my customers are, what my business does, and what the situation is?',
  },
  {
    emoji: '🎨',
    color: 'rgba(56,189,248,0.12)',
    name: 'Tone',
    def: 'Set the voice and feeling',
    ...
    strong:
      'Write in a direct, calm, and accountable tone. Senior professional level. No fluff, no hedging, no passive voice.',
    check:
      'Did I tell AI HOW the response should sound — formal or casual, warm or direct, confident or empathetic?',
  },
  {
    emoji: '📐',
    color: 'rgba(244,63,94,0.12)',
    name: 'Format / Structure',
    def: 'Tell AI how to present the answer',
    why: 'Without format, AI gives a wall of text when you needed 5 short bullet points.',
    weak: 'Explain pricing strategy',
    strong:
      'Give me 3 pricing strategies. For each: name, 2-sentence explanation, one real example. Use a numbered list.',
  ...
  },
  {
    ...
    color: 'rgba(244,63,94,0.12)',
    name: 'Constraints',
    def: 'Set limits on what to avoid',
    why: 'What you tell AI NOT to do is just as important as what you tell it to do.',
    weak: 'Write about our product launch',
    strong:
      'Avoid: jargon like leverage and synergy, bullet points more than 5, passive voice, and any claims that cannot be verified.',
  ...
  },
  {
    ...
    color: 'rgba(16,185,129,0.12)',
    name: 'Example',
    def: 'Show AI exactly what good looks like',
    ...
    strong:
      'Match this style: Revenue grew 18% YoY driven by enterprise expansion, despite macro headwinds. Operating margin improved 3 points. Q4 outlook remains cautious but achievable.',
    check:
      'Have I given AI at least one real example of what a great response looks like?',
  },
  {
    emoji: '🔄',
    color: 'rgba(245,158,11,0.12)',
    name: 'Critique / Self-Review',
    def: 'Ask AI to check its own answer',
    ...
    strong:
      'After writing, re-read once: Is this clear? Is the tone right? Fix anything, then give me the final version only.',
    check:
      'Did I ask AI to review and improve its own answer before giving it to me?',
  },
];
...
const MISTAKES = [
  {
    icon: '💬',
    name: 'Being Too Vague',
    bad: '"Help me with marketing"',
    good: '"Write 3 LinkedIn posts announcing our new product launch. Professional tone, under 150 words each, ends with a question."',
  },
  {
    icon: '🗺',
    name: 'No Context Given',
    bad: '"Write a business plan"',
    good: '"Write a 1-page business case for launching a new product feature, targeting mid-market SaaS companies, with a 6-month ROI projection."',
  },
  {
    icon: '📦',
    name: 'Asking Everything at Once',
    bad: '"Write a plan, 10 posts, and pricing"',
    good: '"One task per prompt. Start: Create a go-to-market strategy for my SaaS product."',
  },
  {
    icon: '📏',
    name: 'No Format Specified',
    bad: '"Explain customer retention"',
    good: '"Explain 3 retention strategies. Each: name, 2-sentence explanation, one example."',
  },
  {
    icon: '🔄',
    name: 'Accepting the First Answer',
    bad: '"(Never follows up)"',
    good: '"Follow up: Make it shorter and casual or Give me 3 different tone options."',
  },
];
...
const FORMULA_ROWS = [
  {
    n: 1,
    label: 'ROLE',
    hint: 'Who should AI be?',
    eg: 'You are a senior strategy consultant with 15 years of experience advising Fortune 500 companies.',
  },
  {
    n: 2,
    label: 'OBJECTIVE',
    hint: 'What exactly do you want done?',
    eg: 'Write a concise executive summary for a Q3 performance review presentation.',
  },
  {
    n: 3,
    label: 'CONTEXT',
    hint: 'What is your situation?',
    eg: 'I am a product manager at a 200-person SaaS company presenting to the leadership team next Friday.',
  },
  {
    n: 4,
    label: 'TONE',
    hint: 'How should it sound and feel?',
    eg: 'Direct, professional, and confident. Senior leadership level. No filler words or hedging.',
  },
  {
    n: 5,
    label: 'FORMAT',
    hint: 'How should the answer look?',
    eg: '3 paragraphs: key achievements, risks, and Q4 outlook. Each paragraph under 60 words. No bullet points.',
  },
  {
    n: 6,
    label: 'CONSTRAINTS',
    hint: 'What should AI avoid?',
    eg: 'No jargon like leverage or synergy. No passive voice. No claims without supporting context.',
  },
  {
    n: 7,
    label: 'EXAMPLE',
    hint: 'Show what good looks like',
    eg: 'Style: Last quarter we grew ARR by 18% despite headwinds in the enterprise segment...',
  },
  {
    n: 8,
    label: 'CRITIQUE',
    hint: 'Ask AI to review its own answer',
    eg: 'After writing, re-read and fix anything that does not match. Give final version only.',
  },
];
...
const DAILY_CHALLENGES = [
  {
    ...
    hint: 'Use Role + Context + Tone',
    scenario:
      'Write a balanced annual performance review for a mid-level analyst on your team who delivered strong results but struggles with meeting deadlines. It will be shared with HR and used in a one-on-one conversation.',
  },
  {
    title: 'Prepare a stakeholder update email',
    hint: 'Use Format + Constraints + Critique',
    scenario:
      'Your project is 2 weeks behind schedule due to a vendor delay. Write a concise update email to your CFO and CTO that is transparent, solution-focused, and under 150 words.',
  },
  {
    title: 'Pitch a new idea to your manager',
    hint: 'Use Role + Objective + Format',
    scenario:
      "You want to propose switching your team's project management tool from email threads to Notion. Write a short persuasive message to your manager making the case in under 100 words.",
  },
  {
    title: 'Summarise a long meeting into actions',
    hint: 'Use Format + Constraints',
    scenario:
      'You just attended a 90-minute strategy meeting with 5 stakeholders. Write a crisp follow-up summary with clear owners, action items, and deadlines — something the team can act on immediately.',
  },
  {
    title: 'Write a follow-up after a job interview',
    hint: 'Use Tone + Context + Critique',
    scenario:
      'You interviewed for a Senior Product Manager role yesterday. The panel included the CPO and two team leads. Write a follow-up email that is warm, professional, and reinforces one specific thing you discussed.',
  },
  {
    title: 'Create a LinkedIn post from a win',
    hint: 'Use Role + Tone + Example',
    scenario:
      'Your team just shipped a feature that reduced customer churn by 12%. Write a LinkedIn post sharing this achievement in a way that is credible, not boastful, and invites conversation.',
  },
  {
    title: 'Draft a difficult message to a client',
    hint: 'Use Tone + Constraints + Critique',
    scenario:
      'A key deliverable will be delayed by one week due to an internal resourcing issue. Write a professional WhatsApp or email message to the client that owns the mistake and proposes a solution.',
  },
];
...
const TRACKS = [
  {
    ...
    desc: 'Sales, strategy, operations',
  },
  {
    id: 'marketing',
    label: '📣 Marketing',
    desc: 'Campaigns, content, branding',
  },
  { id: 'sales', label: '💰 Sales', desc: 'Pitches, follow-ups, closing' },
  {
    id: 'content',
    label: '✍ Content Creation',
    desc: 'Social, blogs, scripts',
  },
  { id: 'hr', label: '👥 HR & Recruitment', desc: 'Hiring, reviews, policies' },
  {
    id: 'finance',
    label: '💳 Finance & Planning',
    desc: 'Budgets, reports, proposals',
  },
  {
    id: 'customer',
    label: '🎧 Customer Service',
    desc: 'Complaints, support, retention',
  },
  {
    id: 'ecommerce',
    label: '🛒 E-Commerce',
    desc: 'Product, listings, reviews',
  },
  {
    id: 'realestate',
    label: '🏠 Real Estate',
    desc: 'Listings, pitches, emails',
  },
  {
    id: 'education',
    label: '📚 Education & Training',
    desc: 'Lessons, assessments, plans',
  },
  {
    id: 'healthcare',
    label: '🏥 Healthcare & Wellness',
    desc: 'Patient comms, wellness plans',
  },
  {
    id: 'legal',
    label: '⚖ Legal & Compliance',
    desc: 'Contracts, policies, notices',
  },
  {
    id: 'freelance',
    label: '🧑💻 Freelancing',
    desc: 'Proposals, rates, client emails',
  },
  {
    id: 'personal',
    label: '🌱 Personal Growth',
    desc: 'Goals, habits, communication',
  },
  {
    id: 'students',
    label: '🎓 Students',
    desc: 'Study plans, essays, research',
  },
];
const TABS = [
...
const PROMPT_LIBRARY = [
  ...
  },
  {
    ...
    prompts: [
      ...
      {
        title: 'Annual Contract Renewal Email',
        prompt:
      ...
      {
        title: 'Sales Team Motivation Message',
        prompt:
      ...
      {
        title: 'Competitive Comparison Script',
        prompt:
  ...
  },
  {
    ...
    prompts: [
      ...
      {
        title: 'Pay Rise Request Template',
        prompt:
  ...
  },
  {
    ...
    prompts: [
      ...
      {
        title: 'Plain-Language P and L Summary',
        prompt:
      ...
      {
        title: 'Profit Reinvestment Plan',
        prompt:
  ...
  },
  {
    ...
    prompts: [
      ...
      {
        title: '90-Day Personal Development Plan',
        prompt:
  ...
  },
  {
    ...
    prompts: [
      ...
      {
        title: 'Wrong Item Received Response',
        prompt:
  ...
  },
  {
    ...
    prompts: [
      ...
      {
        title: 'Competitive Advantage Statement',
        prompt:
  ...
  },
  {
    ...
    prompts: [
      ...
      {
        title: 'Leadership Development Programme Plan',
        prompt:
...
function CopyBtn(props) {
  ...
  return React.createElement(
    'button',
    { className: 'copy-btn' + (isDone ? ' done' : ''), onClick: handle },
    isDone ? 'Copied' : label
  );
}
...
function FeedbackCard(props) {
  ...
  var present = BLOCKS.filter(function (b) {
    return presentLine.toLowerCase().indexOf(b.toLowerCase()) >= 0;
  });
  var missing = BLOCKS.filter(function (b) {
    return missingLine.toLowerCase().indexOf(b.toLowerCase()) >= 0;
  });
  ...
  return React.createElement(
    ...
    bestPart &&
      React.createElement(
        'div',
        { style: { marginBottom: 10, fontSize: 13, lineHeight: 1.6 } },
        React.createElement(
          'strong',
...
const LESSONS = [
  {
    num: 1,
    emoji: '🧱',
    label: 'The 8 Building Blocks',
    sub: 'What every great prompt needs and why',
    bg: 'rgba(99,102,241,0.15)',
    tc: 'var(--indigo-l)',
    bc: 'rgba(99,102,241,0.3)',
  },
  {
    num: 2,
    emoji: '✦',
    label: 'The Master Formula',
    sub: 'All 8 blocks working together in one real prompt',
  ...
  },
  {
    num: 3,
    emoji: '🔄',
    label: 'The 7-Step Improvement Loop',
    sub: 'Build any prompt step by step, start rough finish strong',
  ...
  },
  {
    ...
    emoji: '⚡',
    label: '3 Power Moves',
    sub: 'One line that instantly upgrades any prompt',
    bg: 'rgba(16,185,129,0.15)',
    tc: 'var(--emerald)',
    bc: 'rgba(16,185,129,0.3)',
  },
  {
    ...
    sub: 'The mindset that separates great prompts from lucky ones',
    bg: 'rgba(245,158,11,0.15)',
    tc: 'var(--amber)',
    bc: 'rgba(245,158,11,0.3)',
  },
  {
    ...
    sub: 'What kills AI results and how to fix it',
    bg: 'rgba(244,63,94,0.12)',
    tc: 'var(--rose)',
    bc: 'rgba(244,63,94,0.25)',
  },
  {
    num: 7,
    emoji: '🔥',
    label: 'Before vs After',
    sub: 'Same task, see the transformation a great prompt makes',
    bg: 'rgba(56,189,248,0.12)',
    tc: 'var(--sky)',
    bc: 'rgba(56,189,248,0.25)',
  },
];
...
export default function PromptCoach() {
  ...
  async function suggestPersona() {
    ...
    try {
      var sys =
        'You are an expert in AI prompt engineering. Based on the task described, suggest the ideal expert persona or team.\n\nReply in this EXACT format:\n\nRECOMMENDED PERSONA:\n[role title or team]\n\nWHY THIS WORKS:\n[2 sentences]\n\nALTERNATIVE:\n[simpler single role]';
      var result = await callClaude(
        [{ role: 'user', content: 'Task: ' + personaTask }],
        sys,
        300
      );
  ...
  function applyPersonaSuggestion() {
    var m = personaSuggestion.match(
      /RECOMMENDED PERSONA:\s*([\s\S]*?)(?=WHY THIS WORKS:|$)/i
    );
    if (m) {
  ...
  async function getLearnThis(title, prompt) {
    ...
    try {
      ...
      setLearnThis({
        ...
        prompt: prompt,
        loading: false,
        breakdown: 'Could not load. Please try again.',
      });
    }
  }
  ...
  var todayChallenge =
    DAILY_CHALLENGES[new Date().getDay() % DAILY_CHALLENGES.length];
  ...
  async function addToHistory(label, prompt, output) {
    setHistory(function (prev) {
      ...
      try {
        window.storage.set('promptcoach-history', JSON.stringify(updated));
      } catch (e) {}
      return updated;
    });
  }
  ...
  async function clearHistory() {
    setHistory([]);
    try {
      await window.storage.delete('promptcoach-history');
    } catch (e) {}
  }
  ...
  async function runCompare(side) {
    ...
    try {
      var result = await callClaude(
        ...
        'You are a helpful AI assistant. Answer the prompt directly.',
        600
      );
      if (side === 'A') setCmpOutA(result);
      else setCmpOutB(result);
    } finally {
      if (side === 'A') setLoadingCmpA(false);
      else setLoadingCmpB(false);
    }
  }
  ...
  async function runWizard() {
    ...
    try {
      var finalRole =
        wiz.role === 'Others'
          ? customRole.trim() || 'the most appropriate expert'
          : wiz.role || 'the most appropriate expert';
      var critLine = wiz.critique
        ? 'After writing, re-read and fix anything that does not match. Give final version only.'
        : '';
      var sys =
        'You are a world-class prompt engineer. Build a complete professional AI prompt from the user answers. Follow the 8-block structure. Return ONLY the finished prompt.';
      var msg =
        'Build a prompt:\n1. ROLE: ' +
        finalRole +
        '\n2. OBJECTIVE: ' +
        wiz.objective +
        '\n3. CONTEXT: ' +
        (wiz.context || 'Not provided') +
        '\n4. TONE: ' +
        (wiz.tone || 'Professional') +
        '\n5. FORMAT: ' +
        (wiz.format || 'Clear and well-structured') +
        '\n6. CONSTRAINTS: ' +
        (wiz.constraints || 'Avoid jargon') +
        '\n7. EXAMPLE: ' +
        (wiz.example || 'Not provided') +
        '\n8. CRITIQUE: ' +
        (critLine || 'Not required');
      var result = await callClaude(
  ...
  async function runBuilder() {
    ...
    try {
      var sys2 =
        'You are a prompt engineer. Improve the given prompt to include: Role, Objective, Context, Tone, Format, Constraints, and a Critique instruction.\nReply in this exact format:\n\nIMPROVED PROMPT:\n[improved prompt]\n\nWHAT WAS MISSING:\n- [issue]\n\nWHY ITS BETTER:\n- [improvement]';
      var improved = await callClaude(
        [{ role: 'user', content: 'Improve: "' + bInput + '"' }],
        sys2,
        1200
      );
      setBOutput(improved);
  ...
  function extractImp(text) {
    var s = text.indexOf('IMPROVED PROMPT:');
    if (s === -1) return text;
  ...
  async function genExs() {
    ...
    setExs([]);
    setAns(['', '', '']);
    setShowIdeal([false, false, false]);
    setFbs(['', '', '']);
    setExScores([null, null, null]);
    var trackMap = {
      business: {
        ind: ['retail shop owner', 'coaching centre', 'manufacturing business'],
        bl: 'Role, Objective, Context, Tone, Format, and Constraints',
      },
      marketing: {
        ind: [
          'Instagram brand manager',
          'digital marketing agency',
          'local business owner',
        ],
        bl: 'Role, Objective, Tone, Format, Example, and Critique',
      },
      sales: {
        ind: ['software sales rep', 'insurance agent', 'freelance designer'],
        bl: 'Role, Objective, Context, Tone, Constraints, and Critique',
      },
      content: {
        ind: ['YouTube creator', 'food blogger', 'LinkedIn educator'],
        bl: 'Role, Objective, Tone, Format, Example, and Critique',
      },
      hr: {
        ind: [
          'HR manager at a startup',
          'recruitment consultant',
          'L&D specialist',
        ],
        bl: 'Role, Objective, Context, Format, Constraints, and Critique',
      },
      finance: {
        ind: [
        ...
        bl: 'Role, Objective, Context, Format, and Constraints',
      },
      customer: {
        ind: [
          'e-commerce support rep',
          'restaurant manager',
          'SaaS support agent',
        ],
        bl: 'Role, Objective, Context, Tone, Constraints, and Critique',
      ...
      education: {
        ind: ['school teacher', 'corporate trainer', 'online course creator'],
        bl: 'Role, Objective, Context, Format, Constraints, and Critique',
      },
      healthcare: {
        ind: ['clinic manager', 'health coach', 'nutritionist'],
        bl: 'Role, Objective, Context, Tone, Format, and Constraints',
      },
      legal: {
        ind: [
      ...
      personal: {
        ind: [
          'professional on personal development',
          'manager improving communication',
          'entrepreneur building habits',
        ],
        bl: 'Role, Objective, Context, Tone, and Format',
      },
      students: {
        ind: [
          'engineering student',
          'MBA student',
          'job seeker writing applications',
        ],
        bl: 'Role, Objective, Context, Format, and Constraints',
      },
    };
    ...
    try {
      var sys =
        'You are a prompt engineering coach. Generate 3 real-world practice exercises for the ' +
        tLabel +
        ' track.\n\nUse this EXACT format:\n\nEXERCISE 1\nSCENARIO: [2 sentences about a ' +
        ind[0] +
        ' needing AI help]\nIDEAL: [Complete prompt using ' +
        picked.bl +
      ...
      var raw = await callClaude(
        [{ role: 'user', content: 'Generate the 3 exercises now.' }],
        sys,
        1200
      );
      var parts = raw.split(/EXERCISE\s+\d+/i).filter(function (p) {
      ...
      var parsed = parts
        ...
        .map(function (block) {
          ...
          return {
            scenario: sm ? sm[1].trim() : '',
            ideal: im ? im[1].trim() : '',
            hint: hm ? hm[1].trim() : '',
          };
        })
        .filter(function (e) {
          return e.scenario.length > 0;
        });
      ...
      setExs([
        {
          scenario: 'Could not generate. Please tap Generate Exercises again.',
          ideal: '',
          hint: '',
        },
      ]);
  ...
  async function getFb(idx) {
    ...
    var nl = loadingFb.slice();
    nl[idx] = true;
    setLoadingFb(nl);
    try {
      var sys =
        'You are a prompt coach. Evaluate against 8 blocks: Role, Objective, Context, Tone, Format, Constraints, Example, Critique.\nReply:\nPRESENT: [blocks present]\nMISSING: [blocks missing]\nBEST PART: [one sentence]\nTOP TIP: [one sentence]\nSCORE: [1-10]/10';
      var result = await callClaude(
        [
          {
            role: 'user',
      ...
      if (m) {
        var sc = parseInt(m[1]);
        var ns = exScores.slice();
        ns[idx] = sc;
        setExScores(ns);
        setPracticeCount(function (p) {
          return p + 1;
        });
      }
    } finally {
      var nl2 = loadingFb.slice();
      nl2[idx] = false;
      setLoadingFb(nl2);
    }
  }
  ...
  async function getDailyFb() {
    ...
    try {
      var sys =
        'You are a prompt coach. Evaluate against 8 blocks.\nReply:\nPRESENT: [blocks present]\nMISSING: [blocks missing]\nBEST PART: [one sentence]\nTOP TIP: [one sentence]\nSCORE: [1-10]/10';
      var result = await callClaude(
        [
          {
            role: 'user',
  ...
  var numBall = function (n) {
    return React.createElement('div', { className: 'wiz-num' }, n);
  };
  var Chip = function (p) {
    return React.createElement(
      'button',
      {
        ...
        style: {
          ...
          border: '1px solid',
          borderColor: p.sel
            ? p.selBorder || 'rgba(99,102,241,0.5)'
            : 'var(--border)',
          background: p.sel
            ? p.selBg || 'rgba(99,102,241,0.18)'
            : 'var(--surface2)',
          color: p.sel ? p.selColor || 'var(--indigo-l)' : 'var(--text2)',
          fontSize: 12,
          fontWeight: 600,
          cursor: 'pointer',
    ...
    React.createElement(
      ...
      React.createElement(
        ...
        React.createElement(
          ...
          React.createElement('span', {
            className: 'burger-line burger-line-bot',
          })
        ),
        React.createElement(
          'div',
          ...
          React.createElement(
            ...
            React.createElement(
              ...
              'Prompt',
              React.createElement('span', null, 'Coach')
            ),
            React.createElement(
              'div',
              {
      ...
      React.createElement(
        'div',
        { key: animKey, className: 'page-enter' },
          ...
          React.createElement(
            ...
            React.createElement(
              ...
              React.createElement(
                'h1',
                null,
                "Tell Us What You Need. We'll Build the Prompt With You."
              ),
              React.createElement(
                'p',
                null,
                'Start with any rough idea - even 3 words is enough. We shape it into a prompt that gets you the result you actually wanted.'
              )
            ),
            React.createElement(
              'div',
              ...
              React.createElement(
                'button',
                {
                  ...
                  style: {
                    ...
                    borderRadius: 'var(--r-sm)',
                    color:
                      history.length > 0 ? 'var(--indigo-l)' : 'var(--text3)',
                    fontSize: 11.5,
                    fontWeight: 600,
                    padding: '5px 10px',
                    cursor: 'pointer',
              ...
              React.createElement(
                ...
                historyLoaded &&
                  ...
                  React.createElement(
                    ...
                    'No history yet. Build or improve a prompt to start tracking.'
                  ),
                historyLoaded &&
                  history.map(function (h) {
                    return React.createElement(
                      ...
                      React.createElement('div', {
                        className: 'hist-dot',
                        style: {
                          background: h.label.startsWith('Built')
                            ? 'var(--emerald)'
                            : 'var(--indigo)',
                        },
                      }),
              ...
              [
                {
                  ...
                  icon: '+',
                  label: 'Build',
                  sub: '8 guided questions',
                },
                {
                  id: 'improve',
                  icon: 'W',
                  label: 'Improve',
                  sub: 'Upgrade a prompt',
                },
                {
                  id: 'compare',
                  icon: '=',
                  label: 'Compare',
                  sub: 'A vs B side by side',
                },
              ].map(function (m) {
                return React.createElement(
                  'button',
                  {
                    ...
                    style: {
                      ...
                      background:
                        bMode === m.id
                          ? 'linear-gradient(135deg,var(--indigo),var(--indigo-d))'
                          : 'transparent',
                      color: bMode === m.id ? '#fff' : 'var(--text2)',
                      fontFamily: "'Plus Jakarta Sans',sans-serif",
                      textAlign: 'center',
            ...
            bMode === 'wizard' &&
              React.createElement(
                ...
                React.createElement(
                  ...
                  'Prompt Builder - 8 Building Blocks'
                ),
                React.createElement(
                  'div',
                  { className: 'card-sub' },
                  'Answer 8 simple questions. We write the expert prompt for you.'
                ),
                React.createElement(
                  'div',
                  ...
                  React.createElement(
                    ...
                    React.createElement(
                      ...
                      "In case you don't find the role or persona you are looking for, or don't know who you want AI to act like - just write what you want to achieve and we will select the role or the team for you."
                    ),
                    React.createElement(
                      'button',
                      {
                        onClick: function () {
                          setShowPersonaSuggester(!showPersonaSuggester);
                          setPersonaSuggestion('');
                          setPersonaTask('');
                        },
                        style: {
                  ...
                  showPersonaSuggester &&
                    React.createElement(
                      ...
                      React.createElement('textarea', {
                        value: personaTask,
                        onChange: function (e) {
                          setPersonaTask(e.target.value);
                        },
                        placeholder:
                          'e.g. Write Instagram captions for my jewellery business, plan a product launch...',
                        rows: 3,
                        style: { minHeight: 70, marginBottom: 8, fontSize: 12 },
                      }),
                      React.createElement(
                        'button',
                        {
                          ...
                          disabled: loadingPersona || !personaTask.trim(),
                      ...
                      loadingPersona &&
                        React.createElement(
                          ...
                          React.createElement('div', {
                            className: 'spinner spinner-indigo',
                            style: {
                              width: 22,
                              height: 22,
                              borderWidth: 3,
                          ...
                          React.createElement(
                            ...
                            React.createElement(
                              ...
                              'Selecting the best expert or team for you'
                            )
                          )
                        ),
                      personaSuggestion &&
                        (function () {
                          var pm = personaSuggestion.match(
                            /RECOMMENDED PERSONA:\s*([\s\S]*?)(?=WHY THIS WORKS:|$)/i
                          );
                          var wm = personaSuggestion.match(
                            /WHY THIS WORKS:\s*([\s\S]*?)(?=ALTERNATIVE:|$)/i
                          );
                          var am = personaSuggestion.match(
                            /ALTERNATIVE:\s*([\s\S]*?)$/i
                          );
                          var persona = pm ? pm[1].trim() : '';
                          var why = wm ? wm[1].trim() : '';
                          var alt = am ? am[1].trim() : '';
                          return React.createElement(
                            'div',
                            { style: { marginTop: 12 } },
                            React.createElement(
                              ...
                              React.createElement(
                                ...
                                {
                                  className: 'btn btn-primary btn-sm',
                                  onClick: applyPersonaSuggestion,
                                },
                                'Use This Expert'
                              )
                            ),
                  ...
                  React.createElement(
                    ...
                    React.createElement(
                      'option',
                      { value: '', disabled: true },
                      'Select an expert persona'
                    ),
                    React.createElement(
                      'optgroup',
                      { label: 'Business and Strategy' },
                      PERSONAS.slice(0, 10).map(function (p) {
                        return React.createElement(
                          'option',
                          { key: p, value: p },
                          p
                    ...
                    React.createElement(
                      ...
                      PERSONAS.slice(10, 20).map(function (p) {
                        return React.createElement(
                          'option',
                          { key: p, value: p },
                          p
                    ...
                    React.createElement(
                      'optgroup',
                      { label: 'Customer and HR' },
                      PERSONAS.slice(20, 30).map(function (p) {
                        return React.createElement(
                          'option',
                          { key: p, value: p },
                          p
                    ...
                    React.createElement(
                      ...
                      PERSONAS.slice(30, 40).map(function (p) {
                        return React.createElement(
                          'option',
                          { key: p, value: p },
                          p
                    ...
                    React.createElement(
                      'optgroup',
                      { label: 'Education and Personal Growth' },
                      PERSONAS.slice(40, 50).map(function (p) {
                        return React.createElement(
                          'option',
                          { key: p, value: p },
                          p
                  ...
                  wiz.role === 'Others' &&
                    React.createElement('input', {
                      ...
                      placeholder:
                        'e.g. Wedding photographer, Astrologer, Cricket coach...',
                      style: {
                        width: '100%',
                        background: 'var(--bg2)',
                ...
                React.createElement(
                  ...
                  React.createElement(
                    ...
                    React.createElement(
                      ...
                      'Objective - What exactly do you want AI to do? *'
                    )
                  ),
                  React.createElement('textarea', {
                    value: wiz.objective,
                    onChange: function (e) {
                      wSet('objective', e.target.value);
                    },
                    placeholder:
                      'e.g. Write a 5-slide executive summary for our Q3 board presentation...',
                    rows: 3,
                    style: { minHeight: 80 },
                  })
                ),
                React.createElement(
                  ...
                  React.createElement(
                    ...
                    React.createElement(
                      ...
                      'Context - Your situation, business and audience'
                    )
                  ),
                  React.createElement('textarea', {
                    value: wiz.context,
                    onChange: function (e) {
                      wSet('context', e.target.value);
                    },
                    placeholder:
                      'e.g. I am a product manager at a 300-person B2B SaaS company. My audience is the C-suite...',
                    rows: 3,
                    style: { minHeight: 76 },
                  })
                ),
                React.createElement(
                  ...
                  React.createElement(
                    ...
                    React.createElement(
                      ...
                      'Tone - How should it sound and feel?'
                    )
                  ),
                  React.createElement(
                    'div',
                    { className: 'wiz-chip-row' },
                    TONES.map(function (t) {
                      return React.createElement(Chip, {
                        key: t,
                        label: t,
                        sel: wiz.tone === t,
                        selBorder: 'rgba(16,185,129,0.5)',
                        selBg: 'rgba(16,185,129,0.15)',
                        selColor: 'var(--emerald)',
                        onClick: function () {
                          wSet('tone', wiz.tone === t ? '' : t);
                        },
                      });
                    })
                  )
                  ...
                  React.createElement(
                    ...
                    FORMATS.map(function (f) {
                      return React.createElement(Chip, {
                        ...
                        label: f,
                        sel: wiz.format === f,
                        selBorder: 'rgba(245,158,11,0.5)',
                        selBg: 'rgba(245,158,11,0.15)',
                        selColor: 'var(--amber)',
                        onClick: function () {
                          wSet('format', wiz.format === f ? '' : f);
                        },
                      });
                    })
                  )
                ...
                React.createElement(
                  ...
                  React.createElement(
                    ...
                    React.createElement(
                      ...
                      'Constraints - What should AI avoid? (optional)'
                    )
                  ),
                  React.createElement('input', {
                    type: 'text',
                    value: wiz.constraints,
                    onChange: function (e) {
                      wSet('constraints', e.target.value);
                    },
                    placeholder:
                      'e.g. No jargon, no passive voice, no bullet points over 5, avoid words like leverage or synergy...',
                    style: {
                      width: '100%',
                      background: 'var(--bg2)',
                      border: '1px solid var(--border)',
                ...
                React.createElement(
                  ...
                  React.createElement(
                    ...
                    React.createElement(
                      ...
                      'Example - Show AI what good looks like (optional)'
                    )
                  ),
                  React.createElement('textarea', {
                    value: wiz.example,
                    onChange: function (e) {
                      wSet('example', e.target.value);
                    },
                    placeholder:
                      'e.g. Paste a sentence or paragraph that shows the style, tone, or structure you want...',
                    rows: 2,
                    style: { minHeight: 70 },
                  })
                ),
                React.createElement(
                  ...
                  React.createElement(
                    ...
                    React.createElement(
                      ...
                      'Critique - Ask AI to review its own answer?'
                    )
                  ),
                  React.createElement(
                    'div',
                    ...
                    [
                      {
                        v: true,
                        label: 'Yes - polish before delivering',
                        c: 'var(--emerald)',
                        bg: 'rgba(16,185,129,0.12)',
                        bc: 'rgba(16,185,129,0.4)',
                      },
                      {
                        v: false,
                        label: 'No - use first answer',
                        c: 'var(--text2)',
                        bg: 'var(--surface2)',
                        bc: 'var(--border)',
                      },
                          ...
                          style: {
                            ...
                            border:
                              ...
                              (wiz.critique === opt.v
                                ...
                                : 'var(--border)'),
                            background:
                              wiz.critique === opt.v ? opt.bg : 'transparent',
                            color:
                              wiz.critique === opt.v ? opt.c : 'var(--text3)',
                            fontFamily: "'Plus Jakarta Sans',sans-serif",
                            fontSize: 12,
                            fontWeight: 600,
                            cursor: 'pointer',
                ...
                React.createElement(
                  ...
                  React.createElement(
                    'button',
                    {
                      ...
                      onClick: runWizard,
                      disabled: loadingWiz || !wiz.objective.trim(),
                    },
                    loadingWiz
                      ? React.createElement(
                          React.Fragment,
                  ...
                  wiz.objective &&
                    React.createElement(
                      'button',
                      { className: 'btn btn-ghost', onClick: resetWiz },
                      'Reset'
                    )
                ),
                wizOut &&
                  React.createElement(
                    'div',
                    { className: 'output-block', style: { marginTop: 16 } },
                    React.createElement(
                      'div',
            ...
            bMode === 'improve' &&
              React.createElement(
                ...
                React.createElement(
                  'div',
                  { className: 'card-title' },
                  React.createElement('div', { className: 'icon' }, 'W'),
                  'Improve My Prompt'
                ),
                React.createElement(
                  'div',
                  { className: 'card-sub' },
                  'Share a rough idea - we improve it, run it, and show you the real AI output.'
                ),
                React.createElement(
                  'div',
                  { className: 'section-label' },
                ...
                React.createElement('textarea', {
                  ...
                  placeholder:
                    "Paste your rough idea here - even 3 words is enough. Try: 'Help me write an email to my manager'",
                  rows: 4,
                }),
                React.createElement(
                  'div',
                ...
                bOutput &&
                  (function () {
                    ...
                    var misMatch = bOutput.match(
                      /WHAT WAS MISSING:\s*([\s\S]*?)(?=WHY ITS BETTER:|$)/i
                    );
                    var whyMatch = bOutput.match(
                      /WHY ITS BETTER:\s*([\s\S]*?)$/i
                    );
                    var mis = misMatch ? misMatch[1].trim() : '';
                    var why = whyMatch ? whyMatch[1].trim() : '';
                    return React.createElement(
                      'div',
                      { style: { marginTop: 14 } },
                      versions.length > 0 &&
            ...
            bMode === 'compare' &&
              React.createElement(
                ...
                React.createElement(
                  'div',
                  { className: 'card-sub' },
                  'Write two prompts for the same task. Run both. See which wins.'
                ),
                React.createElement(
                  'div',
                  ...
                  React.createElement(
                    ...
                    {
                      className: 'btn btn-primary btn-sm',
                      onClick: runBothCompare,
                      disabled:
                        (!cmpA.trim() && !cmpB.trim()) ||
                        loadingCmpA ||
                        loadingCmpB,
                    },
                    loadingCmpA || loadingCmpB
                      ? React.createElement(
                          React.Fragment,
                          null,
                          React.createElement('div', { className: 'spinner' }),
                    ...
                    React.createElement(
                      ...
                      React.createElement(
                        'button',
                        {
                          ...
                          disabled: loadingCmpA || !cmpA.trim(),
                        },
                        loadingCmpA
                          ? React.createElement(
                              React.Fragment,
                    ...
                    React.createElement(
                      ...
                      React.createElement(
                        'button',
                        {
                          ...
                          disabled: loadingCmpB || !cmpB.trim(),
                        },
                        loadingCmpB
                          ? React.createElement(
                              React.Fragment,
                ...
                (cmpOutA || cmpOutB || loadingCmpA || loadingCmpB) &&
                  React.createElement(
                    'div',
                    null,
                    React.createElement('div', {
                      ...
                      React.createElement(
                        ...
                        loadingCmpA
                          ...
                          : React.createElement(
                              ...
                              cmpOutA || 'Run Prompt A to see output'
                            ),
                        cmpOutA &&
                          React.createElement(
                            'div',
                      ...
                      React.createElement(
                        ...
                        loadingCmpB
                          ...
                          : React.createElement(
                              ...
                              cmpOutB || 'Run Prompt B to see output'
                            ),
                        cmpOutB &&
                          React.createElement(
                            'div',
          ...
          React.createElement(
            ...
            React.createElement(
              ...
              React.createElement(
                'h1',
                null,
                "You Don't Need to Be Technical. You Need the Right Framework."
              ),
              React.createElement(
                'p',
                null,
                'Learn the 8 building blocks of a great prompt in plain English. Each lesson takes under 5 minutes.'
              )
            ),
            React.createElement(
              'div',
              {
                onClick: function () {
                  window.open('https://youtu.be/ezmuCprlTVE', '_blank');
                },
                style: {
                  marginBottom: 18,
                  background: 'var(--surface)',
              ...
              React.createElement(
                ...
                React.createElement(
                  ...
                  React.createElement('div', {
                    style: {
                      ...
                      borderLeft: '10px solid var(--rose)',
                      marginLeft: 2,
                    },
                  })
                ),
                React.createElement(
                  ...
                  React.createElement(
                    ...
                    'A quick walkthrough of how PromptCoach works'
                  )
                )
              ),
              React.createElement(
                'div',
                {
                  style: {
                    ...
                    paddingBottom: '26%',
                    height: 0,
                    background: 'linear-gradient(135deg,#0b0f1d,#111a2e)',
                  },
                },
                React.createElement(
                  'div',
            ...
            LESSONS.map(function (lesson) {
              ...
              return React.createElement(
                'div',
                {
                  ...
                  style: { borderColor: isOpen ? lesson.bc : 'var(--border)' },
                  onClick: function () {
                    ...
                    lesson.num === 1 &&
                      React.createElement(
                        ...
                        React.createElement(
                          ...
                          'Every powerful prompt is built from the same 8 blocks. Tap each to expand.'
                        ),
                        ELEMENTS.map(function (el, i) {
                          return React.createElement(
                            'div',
                            {
                              key: i,
                              className:
                                'el-card' + (openEl === i ? ' open' : ''),
                              onClick: function (e) {
                                e.stopPropagation();
                                setOpenEl(openEl === i ? null : i);
                              },
                            },
                            React.createElement(
                              'div',
                        ...
                        React.createElement(
                          'div',
                          {
                            style: {
                              ...
                              padding: '14px 16px',
                              background:
                                'linear-gradient(135deg,rgba(16,185,129,0.1),rgba(99,102,241,0.06))',
                              border: '1px solid rgba(16,185,129,0.25)',
                              borderRadius: 'var(--r-md)',
                              textAlign: 'center',
                            },
                          ...
                          React.createElement(
                            ...
                            'You just learned the most important framework in AI.'
                          ),
                          React.createElement(
                            'div',
                            {
                            ...
                            '6 lessons left - each one builds on this foundation.'
                          ),
                          React.createElement(
                            'div',
                            {
                    ...
                    lesson.num === 2 &&
                      React.createElement(
                        ...
                        React.createElement(
                          ...
                          'This is what a fully built prompt looks like - every block filled in for a real business scenario.'
                        ),
                    ...
                    lesson.num === 3 &&
                      React.createElement(
                        ...
                        React.createElement(
                          ...
                          'Start rough and add one block at a time. Each step makes your prompt meaningfully better.'
                        ),
                        [
                          ['Write', 'Get your rough idea out first'],
                          ['Add Role', 'You are a [expert] at the very start'],
                          [
                            'Add Objective',
                            'State exactly what you want - specific and clear',
                          ],
                          [
                            'Add Context',
                            'Your business, your customers, the situation',
                          ],
                          ['Add Tone', 'Friendly / formal / direct'],
                          ['Add Format', 'Bullets, numbered list, word count'],
                          [
                            'Add Constraints',
                            'What to avoid: jargon, passive voice',
                          ],
                        ].map(function (item, i) {
                          return React.createElement(
                            'div',
                    ...
                    lesson.num === 4 &&
                      React.createElement(
                        ...
                        React.createElement(
                          ...
                          'Add any of these lines to your prompt and the quality jumps immediately.'
                        ),
                        [
                          {
                            move: 'Think step by step',
                            when: 'Decisions, analysis, planning',
                            why: 'Forces AI to reason carefully before answering.',
                            use: 'Think step by step before giving your final answer.',
                          },
                          {
                            move: 'Give me 3 versions',
                            when: 'Emails, proposals, presentations',
                            why: 'You get options - the 2nd or 3rd version is almost always sharper.',
                            use: 'Give me 3 versions: one concise for a busy executive, one detailed for a technical team, one persuasive for a client pitch.',
                          },
                          {
                            move: 'Explain your reasoning',
                            when: 'Advice, recommendations, strategy',
                            why: 'Makes AI show its thinking so you can challenge it.',
                            use: 'After your answer, briefly explain why you made these choices.',
                          },
                        ].map(function (pm, i) {
                          return React.createElement(
                            'div',
                    ...
                    lesson.num === 5 &&
                      React.createElement(
                        ...
                        [
                          [
                            'One prompt, one goal',
                            'Never ask for 5 things at once. Split complex tasks into separate prompts.',
                          ],
                          [
                            'Longer is not better',
                            'A focused 3-line prompt beats a rambling 10-liner. Clarity wins.',
                          ],
                          [
                            'Your first prompt is a draft',
                            'Always follow up. Refine, redirect, or ask for 3 variations.',
                          ],
                          [
                            'Context is your superpower',
                            'The more AI knows about your world, the more relevant its answer.',
                          ],
                          [
                            'Save what works',
                            'When a prompt gives great results, save it as your personal template.',
                          ],
                        ].map(function (item, i) {
                          return React.createElement(
                            'div',
                        ...
                        MISTAKES.map(function (m, i) {
                          return React.createElement(
                            ...
                            React.createElement(
                              ...
                              React.createElement(
                                'div',
                                { className: 'mistake-bad' },
                                'Bad: ',
                                m.bad
                              ),
                              React.createElement(
                                'div',
                                { className: 'mistake-good' },
                                'Good: ',
                                m.good
                              )
                            )
                    ...
                    lesson.num === 7 &&
                      React.createElement(
                        ...
                        React.createElement(
                          ...
                          'Same task. One prompt gets a useless answer. One gets a result you can actually use.'
                        ),
                        [
                          {
            ...
            React.createElement(
              ...
              React.createElement(CopyBtn, {
                text: 'PROMPT COACH - THE 8 BUILDING BLOCKS:\n1. Role\n2. Objective\n3. Context\n4. Tone\n5. Format\n6. Constraints\n7. Example\n8. Critique',
                label: 'Copy Complete Guide',
              })
            )
          ),
          ...
          React.createElement(
            ...
            React.createElement(
              ...
              React.createElement(
                'h1',
                null,
                'Borrowed From Experts. Ready for Your World.'
              ),
              React.createElement(
                'p',
                null,
                'Pick from ready-made prompts across real-life needs. Use them as-is or tweak them to fit your situation.'
              )
            ),
            React.createElement(
              'div',
              ...
              React.createElement(
                ...
                React.createElement(
                  ...
                  React.createElement(
                    ...
                    '500+ premium prompts, AI generator, team sharing, and advanced templates.'
                  )
                )
              ),
              React.createElement(
                ...
                'Currently free while in beta. Pro plan launching at Rs 199/month.'
              ),
              React.createElement(
                'button',
                {
                  onClick: function () {
                    window.open('https://tally.so/r/rjvEep', '_blank');
                  },
                  style: {
                    width: '100%',
                    padding: '11px 16px',
                  ...
                  React.createElement(
                    ...
                    saved.map(function (s) {
                      return React.createElement(
                        ...
                        {
                          key: s.id,
                          className: 'lib-prompt-card',
                          style: { borderLeft: '2px solid var(--emerald)' },
                        },
                        React.createElement(
                          'div',
                          {
            ...
            React.createElement(
              ...
              React.createElement(
                'button',
                {
                  className: 'lib-cat-btn' + (libCat === -1 ? ' sel' : ''),
                  onClick: function () {
                    setLibCat(-1);
                  },
                },
              ...
              PROMPT_LIBRARY.map(function (cat, i) {
                return React.createElement(
                  ...
                  {
                    key: i,
                    className: 'lib-cat-btn' + (libCat === i ? ' sel' : ''),
                    onClick: function () {
                      setLibCat(i);
                    },
                    style: {
                      borderColor: libCat === i ? cat.tc : 'var(--border)',
                      color: libCat === i ? cat.tc : 'var(--text2)',
                      background: libCat === i ? cat.color : 'var(--surface2)',
                    },
                  },
                  cat.cat
                );
            ...
            PROMPT_LIBRARY.filter(function (cat, i) {
              return libCat === -1 || libCat === i;
            }).map(function (cat, ci) {
              ...
              return React.createElement(
                ...
                filtered.map(function (p, pi) {
                  var isSaved = saved.some(function (s) {
                    return s.prompt === p.prompt;
                  });
                  var isLearning =
                    learnThis &&
                    learnThis.title === p.title &&
                    learnThis.prompt === p.prompt;
                  return React.createElement(
                    'div',
                    { key: pi, className: 'lib-prompt-card' },
                    React.createElement(
                      'div',
                      { className: 'lib-prompt-title' },
                      p.title
                    ...
                    React.createElement(
                      ...
                      React.createElement(
                        ...
                        isLearning ? 'Hide' : 'Why This Works'
                      )
                    ),
                    isLearning &&
                      React.createElement(
                        ...
                        learnThis.loading
                          ? React.createElement(
                              ...
                              React.createElement(
                                'span',
                                null,
                                'Analysing the 8 building blocks...'
                              )
                            )
                          : (function () {
                              ...
                              var bm = bd.match(
                                /BLOCKS USED:\s*([\s\S]*?)(?=KEY LESSON:|$)/i
                              );
                              var lm = bd.match(
                                /KEY LESSON:\s*([\s\S]*?)(?=TRY IT YOURSELF:|$)/i
                              );
                              var tm = bd.match(
                                /TRY IT YOURSELF:\s*([\s\S]*?)$/i
                              );
                              var blocksText = bm ? bm[1].trim() : '';
                              var lesson2 = lm ? lm[1].trim() : '';
                              var tryIt = tm ? tm[1].trim() : '';
                              return React.createElement(
                                'div',
                                {
                                  style: {
          ...
          React.createElement(
            ...
            React.createElement(
              ...
              React.createElement(
                'h1',
                null,
                'Every Attempt Makes the Next One Better.'
              ),
              React.createElement(
                'p',
                null,
                'Try real-world scenarios and get honest feedback on your prompts. No jargon - just clear guidance.'
              )
            ),
            practiceCount > 0 &&
              React.createElement(
            ...
            React.createElement(
              ...
              showDaily &&
                React.createElement(
                  ...
                  React.createElement(
                    'div',
                    { className: 'section-label', style: { marginBottom: 7 } },
                    'Your prompt attempt'
                  ),
                  React.createElement('textarea', {
                    value: dailyAns,
                    onChange: function (e) {
                      setDailyAns(e.target.value);
                    },
                    placeholder:
                      "Write your best prompt for today's challenge...",
                    rows: 5,
                  }),
                  React.createElement(
                    'div',
                    ...
                    React.createElement(
                      'button',
                      {
                        className: 'btn btn-primary btn-sm',
                        onClick: getDailyFb,
                        disabled: loadingDaily || !dailyAns.trim(),
                      },
                      loadingDaily
                        ? React.createElement(
                            React.Fragment,
                  ...
                  dailyFb &&
                    React.createElement(FeedbackCard, { text: dailyFb })
                )
            ),
            React.createElement(
              'div',
              ...
              React.createElement(
                'div',
                { className: 'card-title' },
                React.createElement('div', { className: 'icon' }, 'P'),
                'Practice by Track'
              ),
              React.createElement(
                'div',
                { className: 'card-sub' },
                'Pick your focus area - get 3 real scenarios from that world every time.'
              ),
              React.createElement(
                'select',
                {
              ...
              (function () {
                var sel = TRACKS.find(function (t) {
                  return t.id === track;
                });
                return sel
                  ? React.createElement(
            ...
            loadingEx &&
              React.createElement(
                ...
                React.createElement('span', null, 'Creating exercises...')
              ),
            !loadingEx &&
              exs.length === 0 &&
              React.createElement(
                'div',
                { className: 'empty' },
                React.createElement('div', { className: 'empty-icon' }, 'P'),
                React.createElement(
                  'p',
                  null,
                  'Choose your track and generate exercises. Fresh scenarios every time.'
                )
              ),
            !loadingEx &&
              exs.map(function (ex, i) {
                return React.createElement(
                  'div',
                  { key: i, className: 'ex-card' },
                  React.createElement(
                    'div',
                    { className: 'ex-num' },
                    React.createElement(
                      'div',
                      { className: 'ex-num-pill' },
                      i + 1
                    ),
                    'Exercise ' + (i + 1) + ' of ' + exs.length
                  ),
                  React.createElement(
                    'div',
                    { className: 'ex-scenario' },
                    ex.scenario
                  ),
                  ex.hint &&
                    React.createElement(
                  ...
                  React.createElement(
                    ...
                    React.createElement(
                      'button',
                      {
                        ...
                        disabled: loadingFb[i] || !ans[i].trim(),
                      },
                      loadingFb[i]
                        ? React.createElement(
                            React.Fragment,
                    ...
                    React.createElement(
                      'button',
                      {
                        className: 'btn btn-ghost btn-sm',
                        onClick: function () {
                          var s = showIdeal.slice();
                          s[i] = !s[i];
                          setShowIdeal(s);
                        },
                      },
                      showIdeal[i] ? 'Hide Ideal' : 'Show Ideal'
                    ),
                    ans[i] &&
                      React.createElement(CopyBtn, {
                        text: ans[i],
                  ...
                  fbs[i] &&
                    React.createElement(
                      ...
                      React.createElement(
                        ...
                        'Want to refine this prompt further?'
                      ),
                      React.createElement(
                        'button',
                        {
                  ...
                  showIdeal[i] &&
                    ...
                    React.createElement(
                      'div',
                      { className: 'ideal-block' },
                      React.createElement(
                        'div',
                        { className: 'ideal-header' },
                        React.createElement(
                          'div',
                          { className: 'ideal-label' },
                          'Ideal Prompt'
                        ),
                        React.createElement(CopyBtn, {
                          text: ex.ideal,
            ...
            React.createElement(
                ...
                React.createElement(
                  ...
                  [
                    {
                      icon: 'A',
                      label: 'About Us',
                      sub: 'Who built PromptCoach',
                      page: 'about',
                    },
                    {
                      icon: 'G',
                      label: 'Guide to the App',
                      sub: 'How to use all 4 tabs',
                      page: 'guide_menu',
                    },
                  ].map(function (item) {
                    return React.createElement(
                      'button',
                      {
                        ...
                        className:
                          'menu-item-btn' +
                          (menuPage === item.page ? ' active-page' : ''),
                        onClick: function () {
                          setMenuPage(
                            menuPage === item.page ? 'home' : item.page
                          );
                        },
                      },
                      React.createElement(
                  ...
                  React.createElement(
                    ...
                    React.createElement(
                      ...
                      'PromptCoach is completely free to use. Pro plan launching at Rs 199/month.'
                    ),
                    React.createElement(
                      'button',
                      {
              ...
              menuPage === 'about' &&
                React.createElement(
                  ...
                  [
                    {
                      heading: 'The idea behind PromptCoach',
                      body: 'I built PromptCoach because I was frustrated. Every time I asked AI for help, the results were mediocre - not because the AI was weak, but because I did not know how to ask well. I spent months figuring out what actually works, and realised this knowledge is not available in one simple, practical place.',
                    },
                    {
                      heading: 'Who it is for',
                      body: 'PromptCoach is built for professionals, business owners, and learners who want to get dramatically better results from AI - without learning to code or spending hours reading technical guides. If you use ChatGPT, Claude, or Gemini in your work and feel the results could be better, this is for you.',
                    },
                    {
                      heading: 'What makes it different',
                      body: 'Every other prompt tool either gives you a library to copy-paste from, or a course to read through. PromptCoach does both - and adds something no one else has: real-time AI feedback on your own prompts, so you learn by doing, not just by reading.',
                    },
                    {
                      heading: 'A note from me',
                      body: 'This is a work in progress, built with genuine care. Every lesson, every example, every feature has been thought through for someone who is using AI for the first time or wants to finally get it right. If something does not work or could be better, I want to know.',
                    },
                  ...
                  [
                    {
                      ...
                      what: 'The Learn tab teaches you the 8 building blocks of a great prompt - the same framework used by AI professionals.',
                      how: 'Tap any lesson to expand it. Start with Lesson 1 (The 8 Building Blocks). Each lesson takes under 5 minutes.',
                      tip: 'Finish Lesson 1 before using any other tab - it makes everything else 10x more useful.',
                    },
                    {
                      icon: 'B',
                      tab: 'Build',
                      ...
                      tagline: 'Where you create your prompts.',
                      what: 'Build has 3 modes - Build (guided 8-question wizard), Improve (paste any rough idea and we upgrade it), and Compare (test two prompts side by side).',
                      how: 'New to prompting? Use Build mode. Have a rough idea? Use Improve. Compare lets you test two prompts side by side.',
                      tip: 'In the Role block, tap Help me choose and describe your task - we will suggest the best expert or team.',
                    },
                    {
                      icon: 'P',
                      tab: 'Browse',
                      ...
                      tagline: 'Ready-made expert prompts.',
                      what: 'The Browse tab has professionally crafted prompts across 9 categories - Marketing, Sales, HR, Finance, Customer Service, and more.',
                      how: 'Pick a category, find a prompt, tap Copy to use it. Tap Why This Works to see the 8-block breakdown.',
                      tip: 'Tap Why This Works on at least 3 prompts. It is the fastest way to learn what makes a prompt powerful.',
                    },
                    {
                      icon: 'X',
                      tab: 'Practice',
                      ...
                      tagline: 'Learn by doing - with real feedback.',
                      what: 'Practice gives you real-world scenarios. Write a prompt for each and get AI feedback against all 8 building blocks.',
                      how: 'Choose a track, generate exercises, write your prompt, tap Get Feedback. A Daily Challenge gives you one scenario every day.',
                      tip: 'Do not read the Ideal Prompt before attempting. Write your own first - that is where the learning happens.',
                    },
                  ].map(function (item, i) {
                    return React.createElement(
                      'div',
